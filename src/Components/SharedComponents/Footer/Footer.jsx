...
const Footer = () => {
    return (
        <div>
            <footer>
                <div class="footer-area footer-bg-color" data-bg-color="#030b15" data-background="">
                    <div class="container">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div id="custom_html-3" class="widget_text footer-widget footer-2-col-1 widget_custom_html">
                                        <div class="textwidget custom-html-widget"><a href="https://themedox.com/bigtech/"
                                            class="f-logo"><img
                                                src="https://themedox.com/bigtech/wp-content/themes/bigtech/assets/img/logo/logo.png"
                                                alt="Logo" /></a>
                                ...
                                <div class="col-xl-3 col-lg-5 col-sm-6">
                                    <div id="nav_menu-4" class="footer-widget footer-2-col-2 widget_nav_menu">
                                ...
                                <div class="col-xl-2 col-lg-3 col-sm-6">
                                    <div id="nav_menu-5" class="footer-widget footer-2-col-3 widget_nav_menu">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6">
                                    <div id="custom_html-5" class="widget_text footer-widget footer-2-col-4 widget_custom_html">
                                        <h4 class="fw-title">Send A Private Message</h4>
                                        <div class="textwidget custom-html-widget">
                                            <div class="footer-newsletter">
                                                <p>Your Any Serious Problem, Send Us A Private Message Via This Email</p>
                                                {/* <form action="#">
                                                    <input type="email" readOnly placeholder="Info@gmail.com" required />
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="copyright-text">
                                        <p>Copyright © 2023 Bigtech All Rights Reserved.</p>
                                    </div>
                                </div>
