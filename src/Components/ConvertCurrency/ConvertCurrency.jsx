...
const ConvertCurrency = () => {
    ...
    const calculateResult = () => {
        ...
        const result = isNaN(numericValue) ? '0' : numericValue * 110.14;
        return result.toLocaleString();
    };

    return (
        <div className="flex justify-center items-center mt-[35px] md:mt-[25px]">
            <div className="text-center items-center flex flex-col md:flex-row gap-y-5 gap-x-[55px]">
                ...
                <div className='bg-[#ff9700] p-2 rounded-full hidden md:block'><HumbleiconsExchangeHorizontal></HumbleiconsExchangeHorizontal></div>
                <div className='bg-[#ff9700] p-2 rounded-full block md:hidden'><HumbleiconsExchangeVertical></HumbleiconsExchangeVertical></div>
                <div className='flex items-center gap-x-3'>
